...
public class AnalizadorSintacticoJson extends java_cup.runtime.lr_parser {
     ...
     * Default constructor.
     */
    public AnalizadorSintacticoJson() {
        super();
    }
     ...
     */
    public AnalizadorSintacticoJson(java_cup.runtime.Scanner s) {
        super(s);
    }
     ...
     * Constructor which sets the default scanner.
     */
    public AnalizadorSintacticoJson(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {
        super(s, sf);
    }
        ...
        switch (CUP$AnalizadorSintacticoJson$act_num) {
            ...
            case 59: // Dimension ::= COLUMNAS DOS_PUNTOS NUMERO 
            {
                ...
                if (dimensionMapa.width == 0) {
                    dimensionMapa.width = Integer.valueOf((String) num);
                } else {
            ...
            case 58: // Dimension ::= FILAS DOS_PUNTOS NUMERO 
            {
                ...
                if (dimensionMapa.height == 0) {
                    dimensionMapa.height = Integer.valueOf((String) num);
                } else {
                    errorRecuperable = true;
            ...
            case 50: // AtribsJugador ::= error 
            {
                ...
                asj.ayudarConErrores("AtributoJugador");
            ...
            case 49: // AtribsJugador ::= error COMA AtribsJugador 
            {
                ...
                RESULT = re;
                asj.
                        ayudarConErrores("AtributoJugador");
            ...
            case 41: // AtribsNeutrales ::= error 
            {
                ...
                asj.ayudarConErrores("ConfiguracionNeutral");
            ...
            case 1: // Inicio ::= LLAVE_A Componentes LLAVE_C 
            {
                ...
                if (!Mapa.comprobarComponetesDeConstruicion(componentesPrincipales, asj.fp)) {
                    ...
                    if (!Mapa.verificacionesFinales(mapa, asj.fp)) {
                        asj.setMapa(mapa);
                    } else {
                        error = true;
                    }
                ...
                asj.error = this.error;
                asj.errorRecuperable = this.errorRecuperable;
